...
//query update
$query = mysqli_query($koneksi,"INSERT INTO `tahan_ubah_pengeluaran` (`id_pengeluaran`,`tgl_pengeluaran`, `jam_pengeluaran`, `jumlah`, `nama_perusahaan`, `status`) VALUES ('$id','$tgl', '$jam', '$jumlah', '$perusahaan', '$status')");
