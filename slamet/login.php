    ...
    <!-- PushAlert -->
        <script type="text/javascript">
                (function(d, t) {
                        ...
                        g.src = "https://cdn.pushalert.co/integrate_196cb3a5cdb392ab81f7efcb3fa2fec7.js";
      ...
      <div class="col-xl-5 col-lg-6 col-md-4">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          ...
          <img src="img/icon.png" class="img" width="100px" height="100px">
                  ...
                  <br>
                  <center><a id="setup_button" onclick="installApp()" style="color:blue; cursor:pointer;">Install EWS - HZ</a></center>
                  <br>
