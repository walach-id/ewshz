...
$pemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = '$tgl' and nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$pengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran = '$tgl' and nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$pemasukanseluruh=mysqli_query($koneksi,"SELECT * FROM pemasukan where nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$pengeluaranseluruh=mysqli_query($koneksi,"SELECT * FROM pengeluaran where nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$minggupemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan WHERE tgl_pemasukan > DATE_SUB(NOW(), INTERVAL 1 WEEK) and nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$minggupengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE tgl_pengeluaran > DATE_SUB(NOW(), INTERVAL 1 WEEK) and nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$bulanpemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan where month(tgl_pemasukan) = '$bln' and nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
...
$bulanpengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran where month(tgl_pengeluaran) = '$bln'  and nama_perusahaan NOT IN('admin') and flag1 = '$slamet'");
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?= number_format($jumlahmasukseluruh,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($jumlahkeluarseluruh,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($sisauangseluruh,2,',','.');?></div>
                        </div>   
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?= number_format($jumlahmasuk1,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($jumlahkeluar1,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($sisauanghariini,2,',','.');?></div>
                        </div>   
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($minggujumlahmasuk1,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($minggujumlahkeluar1,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($minggusisauanghariini,2,',','.');?></div>
                        </div>   
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($bulanjumlahmasuk1 ,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-calendar fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($bulanjumlahkeluar1,2,',','.');?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-dollar-sign fa-2x text-gray-300"></i>
                    </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold" style="color: black; font-weight: bold;">Rp.<?=number_format($sisauangbulanini,2,',','.');?></div>
                        </div>   
                      </div>
                   </div>
                    <div class="col-auto">
