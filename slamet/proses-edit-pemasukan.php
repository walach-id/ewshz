...
$query = mysqli_query($koneksi,"INSERT INTO `tahan_ubah_pemasukan` (`id_pemasukan`,`tgl_pemasukan`, `jam_pemasukan`, `jumlah`, `nama_perusahaan`, `status`, `flag1`) VALUES ('$id','$tgl', '$jam', '$jumlah', '$perusahaan', '$status', '$slamet')");
