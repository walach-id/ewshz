...
$minggupemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan WHERE tgl_pemasukan > DATE_SUB(NOW(), INTERVAL 1 WEEK) and nama_perusahaan = '$perusahaan' and NOT flag1='Admin Slamet'");
...
$minggupengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE tgl_pengeluaran > DATE_SUB(NOW(), INTERVAL 1 WEEK) and nama_perusahaan = '$perusahaan' and NOT flag1='Admin Slamet'");
...
$bulanpemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan where month(tgl_pemasukan) = '$bln' and nama_perusahaan = '$perusahaan'  and NOT flag1='Admin Slamet'");
...
$bulanpengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran where month(tgl_pengeluaran) = '$bln' and nama_perusahaan = '$perusahaan'  and NOT flag1='Admin Slamet'");
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2" style="background-color: #08ADBA;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1" style="color: white; font-weight: bold;">Saldo Pemasukan <?php echo date('d-m-Y');?></div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
...
$pemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = '$tgl' and nama_perusahaan NOT IN('admin')");
while ($masuk1=mysqli_fetch_array($pemasukan1)){
$arraymasuk1[] = $masuk1['jumlah'];
}
$jumlahmasuk1 = array_sum($arraymasuk1);
...
$pengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran = '$tgl' and nama_perusahaan NOT IN('admin')");
...
$pemasukanseluruh=mysqli_query($koneksi,"SELECT * FROM pemasukan where nama_perusahaan NOT IN('admin')");
...
$pengeluaranseluruh=mysqli_query($koneksi,"SELECT * FROM pengeluaran where nama_perusahaan NOT IN('admin')");
...
$minggupemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan WHERE tgl_pemasukan > DATE_SUB(NOW(), INTERVAL 1 WEEK) and nama_perusahaan NOT IN('admin')");
...
$minggupengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran WHERE tgl_pengeluaran > DATE_SUB(NOW(), INTERVAL 1 WEEK) and nama_perusahaan NOT IN('admin')");
...
$bulanpemasukan1=mysqli_query($koneksi,"SELECT * FROM pemasukan where month(tgl_pemasukan) = '$bln' and nama_perusahaan NOT IN('admin')");
...
$bulanpengeluaran1=mysqli_query($koneksi,"SELECT * FROM pengeluaran where month(tgl_pengeluaran) = '$bln'  and nama_perusahaan NOT IN('admin')");
...
<?php require 'user.php'; ?>
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Rekapitulasi Keuangan Seluruh Perusahaan</h1> <br>
