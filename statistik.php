...
$karyawan = mysqli_query($koneksi, "SELECT * FROM karyawan where nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
$karyawan = mysqli_num_rows($karyawan);
$perusahaan = $_SESSION['level'];

$pengeluaran_bulan_ini = mysqli_query($koneksi, "SELECT jumlah FROM pengeluaran where tgl_pengeluaran like '%$bulan%' and NOT flag1 = 'Admin Slamet'");
$pengeluaran_bulan_ini = mysqli_fetch_array($pengeluaran_bulan_ini);

$pengeluaran_hari_ini = mysqli_query($koneksi, "SELECT jumlah FROM pengeluaran where tgl_pengeluaran = CURDATE() and NOT flag1 = 'Admin Slamet'");
$pengeluaran_hari_ini = mysqli_fetch_array($pengeluaran_hari_ini);

$pemasukan_bulan_ini = mysqli_query($koneksi, "SELECT jumlah FROM pemasukan where tgl_pemasukan like '%$bulan%' and NOT flag1 = 'Admin Slamet'");
$pemasukan_bulan_ini = mysqli_fetch_array($pemasukan_bulan_ini);

$pemasukan_hari_ini = mysqli_query($koneksi, "SELECT jumlah FROM pemasukan where tgl_pemasukan = CURDATE() and NOT flag1 = 'Admin Slamet'");
$pemasukan_hari_ini = mysqli_fetch_array($pemasukan_hari_ini);



$pemasukan=mysqli_query($koneksi,"SELECT * FROM pemasukan where nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$pengeluaran=mysqli_query($koneksi,"SELECT * FROM pengeluaran where nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$pemasukan2=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() and NOT flag1 = 'Admin Slamet'");
while ($masuk2=mysqli_fetch_array($pemasukan2)){
$arraymasuk2[] = $masuk2['jumlah'];
}
$jumlahmasuk2 = array_sum($arraymasuk2);

$pengeluaran2=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran = CURDATE() and NOT flag1 = 'Admin Slamet'");
...
$hutangbulan=mysqli_query($koneksi,"SELECT * FROM hutang where keterangan='HUTANG' AND tgl_hutang like '%$bulan%' and NOT flag1 = 'Admin Slamet'");
while ($hutangan=mysqli_fetch_array($hutangbulan)){
$arrayhutangbulan[] = $hutangan['jumlah'];
}
$hutangbulanini = array_sum($arrayhutangbulan);

$pemasukanbulan=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$bulan%' and NOT flag1 = 'Admin Slamet'");
...
$pengeluaranbulan=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$bulan%' and NOT flag1 = 'Admin Slamet'");
...
//GRAFIK MINGGUAN
$sekarang=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() and NOT flag1 = 'Admin Slamet'");
...
$satuhari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 1 DAY and NOT flag1 = 'Admin Slamet'");
...
$duahari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 2 DAY and NOT flag1 = 'Admin Slamet'");
...
$tigahari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 3 DAY and NOT flag1 = 'Admin Slamet'");
...
$empathari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 4 DAY and NOT flag1 = 'Admin Slamet'");
...
$limahari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 5 DAY and NOT flag1 = 'Admin Slamet'");
...
$enamhari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 6 DAY and NOT flag1 = 'Admin Slamet'");
...
$tujuhhari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan = CURDATE() - INTERVAL 7 DAY and NOT flag1 = 'Admin Slamet'");
...
//PER BULAN
$masukjanuari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-01-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukfebruari=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-02-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukmaret=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-03-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukapril=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-04-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukmei=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-05-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukjuni=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-06-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukjuli=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-07-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukagustus=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-08-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukseptember=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-09-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukoktober=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-10-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masuknovember=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-11-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$masukdesember=mysqli_query($koneksi,"SELECT * FROM pemasukan where tgl_pemasukan like '%$tahun-12-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
//PER BULAN
$keluarjanuari=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-01-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarfebruari=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-02-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarmaret=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-03-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarapril=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-04-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarmei=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-05-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarjuni=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-06-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarjuli=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-07-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluaragustus=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-08-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarseptember=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-09-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluaroktober=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-10-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluarnovember=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-11-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
...
$keluardesember=mysqli_query($koneksi,"SELECT * FROM pengeluaran where tgl_pengeluaran like '%$tahun-12-%' and nama_perusahaan = '$perusahaan' and NOT flag1 = 'Admin Slamet'");
